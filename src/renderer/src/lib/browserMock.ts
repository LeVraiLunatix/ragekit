    ...
    oiv: {
      ...
      inspect: async (path: string) => ({
        ...
        ops: [
          ...
          { kind: 'xml-edit' as const, target: 'update/update.rpf/common/data/dlclist.xml', archive: 'update/update.rpf', supported: false, reason: 'in-place XML edit — not supported yet' },
        ],
      ...
      install: async (_path: string, target) => ({
        ...
        report: {
          ...
          results: [
            ...
            { target: 'common/data/dlclist.xml', archive: 'update/update.rpf', kind: 'xml-edit' as const, status: 'skipped' as const, detail: 'in-place XML edit — not supported yet' },
          ],
        },
      }),
    },

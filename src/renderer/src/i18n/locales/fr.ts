...
export const fr: Dict = {
  common: {
    ...
    cancel: 'Annuler',
    ok: 'OK',
    restartApp: 'Redémarre Ragekit pour prendre en compte cette mise à jour.',
  },
  lang: {
    fr: 'Français',
    en: 'Anglais',
  ...
  library: {
    ...
    installedCount_one: '{count} installé',
    installedCount_other: '{count} installés',
    search: 'Filtrer les mods…',
    sortBy: 'Trier par',
    sort: {
      order: 'Ordre de chargement',
      category: 'Catégorie',
      name: 'Nom A→Z',
      recent: 'Ajout récent',
      status: 'Statut',
    ...
    delete: 'Supprimer',
    removeSelConfirm: 'Supprimer {count} mods ? Les fichiers qu’ils ont remplacés sont restaurés.',
    orderHint: 'Repasse sur « Ordre de chargement » pour réordonner les mods.',
    noMatch: 'Aucun mod ne correspond.',
  ...
  diag: {
    ...
    stale: 'pas mis à jour',
    showIssues: 'erreurs seules',
    showAll: 'log complet',
  },
  launch: {
    button: 'Lancer GTA V',
    launching: 'Lancement…',
    hint: 'Lance GTA V via PlayGTAV.exe (le chemin du launcher Rockstar) et guette le process du jeu ou un plantage immédiat.',
    title: 'Dernier lancement',
    exe: 'via {exe}',
    running: 'GTA V est lancé',
    crashedEarly: 'Planté au démarrage',
    notStarted: 'GTA V n’a pas démarré',
    notStartedHint:
      'Le launcher / Social Club charge peut-être encore — clique Rafraîchir dans quelques secondes. Si un plantage apparaît ci-dessus, son module défaillant est la cause.',
    failed: 'Impossible de lancer le launcher',
  ...
  activity: {
    ...
    kind: {
      ...
      import: 'Importé',
      bulkEnable: 'Activé',
      bulkDisable: 'Désactivé',
      profileApply: 'Profil appliqué',
    },
  },
  bisect: {
    title: 'Trouver le mod qui plante',
    body: 'Coupe tes mods installés en deux — tu testes, ça se resserre. Quelques lancements et tu as le coupable.',
    start: 'Démarrer',
    needTwo: 'Il faut au moins 2 mods installés.',
    remaining_one: '{count} restant',
    remaining_other: '{count} restants',
    testing: 'Seule cette moitié est active :',
    active: 'actifs',
    parked: 'mis de côté',
    question: 'Lance GTA V. Ça a planté ?',
    crashed: 'Ça a planté',
    ok: 'Ça a marché',
    cancel: 'Annuler',
    culprit: 'Coupable : {name}',
    keepDisabled: 'Le laisser désactivé, réactiver le reste',
    restoreAll: 'Tout réactiver',
    notAmongMods: 'Le crash ne vient pas d’un mod géré — vérifie les loaders, args.txt ou l’install du jeu.',
  },
  profileIo: {
    export: 'Exporter',
    ...
    missing: '{count} mod(s) absent(s) de ta bibliothèque : {list}',
    badFile: 'Ce fichier n’est pas un profil Ragekit.',
  },
  add: {
    ...
    chooseOiv: 'Installer un paquet .oiv…',
    oivHint: 'Un paquet .oiv ouvre son propre installeur.',
    install: 'Installer',
    noMeta: 'Aucune métadonnée',
  },
  oiv: {
    installer: 'Paquet OIV',
    reading: 'Lecture du paquet…',
    cantRead: 'Ce paquet .oiv n’a pas pu être lu.',
    by: 'par {author}',
    version: 'v{version}',
    installTo: 'Installer dans',
    gameFolder: 'Dossier Grand Theft Auto V',
    gameFolderSub: 'Les fichiers sont écrits directement dans le jeu. Plus dur à annuler.',
    modsFolder: 'dossier mods',
    modsFolderSub:
      'Le jeu le lit via le loader OpenIV.asi. Tes fichiers d’origine restent intacts.',
    recommended: 'recommandé',
    detected: 'détecté',
    willCreate: 'sera créé',
    contents: 'Contenu',
    noOps: 'Ce paquet ne déclare aucune opération sur des fichiers.',
    looseFile: 'fichier libre',
    willApply: 'sera appliqué',
    needsOpenIV: 'pas encore pris en charge',
    op: {
      add: 'Ajout',
      replace: 'Remplace',
      delete: 'Supprime',
    ...
    skippedHint:
      'Les opérations grisées sont celles que Ragekit ne sait pas encore appliquer : remplacer un modèle ou une texture dans une .rpf, les archives imbriquées et les éditions XML in-place.',
    ...
    doneHint: 'Le paquet est maintenant dans ta bibliothèque — désactive-le pour annuler.',
  },
  plan: {
    files_one: '{count} fichier',
    files_other: '{count} fichiers',
  ...
  admin: {
    ...
    bannerBody:
      'Le dossier de GTA V n’autorise l’écriture qu’aux administrateurs. Relance Ragekit en administrateur pour installer des mods, mettre les loaders de côté et éditer les archives.',
  ...
  archives: {
    ...
    subtitle: 'Explore les archives .rpf de GTA V : extraire, prévisualiser, remplacer des fichiers.',
    setFolderFirst: 'Définis d’abord ton dossier de jeu',
    game: 'Jeu',
    mods: 'Dossier mods/',
    open: 'Ouvrir',

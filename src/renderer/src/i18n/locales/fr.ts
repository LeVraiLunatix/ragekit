...
export const fr: Dict = {
  ...
  add: {
    ...
    oivHint: 'Un paquet .oiv ouvre l’installeur façon OpenIV.',
    install: 'Installer',
  ...
  oiv: {
    ...
    modsFolderSub:
      'Façon OpenIV — le jeu le lit via le loader OpenIV.asi. Tes fichiers d’origine restent intacts.',

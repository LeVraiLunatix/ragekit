...
export const en = {
  ...
  library: {
    ...
    disableSel: 'Disable',
    delete: 'Delete',
    removeSelConfirm: 'Delete {count} mods? Any files they replaced are restored.',
    orderHint: 'Switch to “Load order” to reorder mods.',
    noMatch: 'No mod matches.',
  ...
  activity: {
    ...
    kind: {
      ...
      import: 'Imported',
      bulkEnable: 'Enabled',
      bulkDisable: 'Disabled',
      profileApply: 'Profile applied',
    },
  },
  bisect: {
    title: 'Find the mod that crashes',
    body: 'Splits your installed mods in half — you test, it narrows down. A few launches and you have the culprit.',
    start: 'Start',
    needTwo: 'Need at least 2 installed mods.',
    remaining_one: '{count} left',
    remaining_other: '{count} left',
    testing: 'Only this half is active right now:',
    active: 'active',
    parked: 'parked',
    question: 'Launch GTA V. Did it crash?',
    crashed: 'It crashed',
    ok: 'It ran fine',
    cancel: 'Cancel',
    culprit: 'Culprit: {name}',
    keepDisabled: 'Keep it off, re-enable the rest',
    restoreAll: 'Re-enable everything',
    notAmongMods: "The crash isn't from a managed mod — check loaders, args.txt or the game install.",
  },
  profileIo: {
    export: 'Export',
    ...
    missing: '{count} mod(s) not in your library: {list}',
    badFile: 'That file is not a Ragekit profile.',
  },
  add: {
    title: 'Add mods',
    subtitle:
  ...
  oiv: {
    installer: 'OIV package',
    reading: 'Reading package…',
    cantRead: 'This .oiv package could not be read.',
    by: 'by {author}',
    version: 'v{version}',
    installTo: 'Install to',
    gameFolder: 'Grand Theft Auto V folder',
    ...
    doneHint: 'The package is now in your Library — toggle it off to undo.',
  },
  plan: {
    files_one: '{count} file',
    files_other: '{count} files',
